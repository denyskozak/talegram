...
import {
  ...
  isGlobalCategory,
  type GlobalCategory,
} from "@/shared/constants/globalCategories";
...
export function PublishSection({
  ...
  if (isGlobalCategorySelected) {
    const categoryKey = formState.globalCategory as GlobalCategory;
    categoryOptions = CATEGORY_OPTIONS_BY_GLOBAL[categoryKey];
  }
